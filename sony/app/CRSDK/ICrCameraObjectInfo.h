...
public:
	...
	// device SSH Support
	virtual CrInt32u GetSSHsupport() const = 0;

	// IP Address (4byte)
	virtual CrInt32u GetIPAddress() const = 0;

	// IP Address char
	virtual CrChar* GetIPAddressChar() const = 0;
	virtual CrInt32u GetIPAddressCharSize() const = 0;

	// MAC Address (6byte)
	virtual CrInt8u* GetMACAddress() const = 0;
	virtual CrInt32u GetMACAddressSize() const = 0;

	// MAC Address char
	virtual CrChar* GetMACAddressChar() const = 0;
	virtual CrInt32u GetMACAddressCharSize() const = 0;
